  ...
  <link href="https://cdn.datatables.net/v/dt/dt-1.13.3/b-2.3.5/rg-1.3.0/rr-1.3.2/sb-1.4.0/sp-2.1.1/sl-1.6.1/datatables.min.css"/>
              ...
              <div class="card">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">Ajouter Conducteur</h6>
                </div>
                  ...
                  <thead class="thead-light">
                    ...
                    <tbody>
                        @foreach ($data as $data ) <a href="souscripteur/{{$data->id_souscripteur}}/conducteur">
                      <tr> 
                        <td>{{$data->cin}}</td>
                        <td>{{$data->nom}}</td> 
                        <td>
                            <button  class="btn btn-sm btn-primary"
                                     onclick="window.location='souscripteur/{{$data->id_souscripteur}}/conducteur';">ajouter</button>
                        </td>
