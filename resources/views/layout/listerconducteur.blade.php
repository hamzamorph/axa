                  ...
                  <thead class="thead-light">
                    ...
                    <tbody>
                      ...
                      <td>{{$conducteurs->cin}}</td>
                        <td>{{$conducteurs->nom}}</td>   
                      <td>{{$conducteurs->prenom}}</td>  
                        <td>{{$conducteurs->num_permis}}</td> 
                       
                        <td>
                           <a href= "editerconducteur/{{$conducteurs->id}}" class="btn btn-success">Edit</a>
                        </td>
                        
                        <td>
                           <form action="{{url('deleteconducteur/'.$conducteurs->id)}}" method="POST">
                            @csrf
                            @method('DELETE')
